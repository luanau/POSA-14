        ...
        Runnable downloadRunnable = new Runnable() {
			...
			public void run() {
		        ...
		        if (extras != null) {
		            ...
		            Messenger messenger = (Messenger) extras.get(DownloadUtils.MESSENGER_KEY);
		        	DownloadUtils.downloadAndRespond(ThreadPoolDownloadService.this, uri, messenger);//Context of this service itself
		        }
